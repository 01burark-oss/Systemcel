...
namespace Systemcel.Api.Printing
{
    internal static class PrintReportHtmlExporter
    {
        public static string Generate(PrintReportData report)
        {
            ...
            html.AppendLine("<html lang=\"tr\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>" + Encode(report.ReportTitle) + "</title>");
            html.AppendLine("<style>");
            html.AppendLine(":root{--ink:#0b0c09;--paper:#f7f5ed;--surface:#fffef9;--line:#d8d5ca;--muted:#6f7069;--lime:#b9ff00;}");
            html.AppendLine("*{box-sizing:border-box;}body{font-family:'Segoe UI Variable Text','Segoe UI',sans-serif;background:var(--paper);color:var(--ink);margin:0;padding:28px;}");
            html.AppendLine(".page{max-width:1040px;margin:0 auto;border:1px solid var(--line);border-radius:22px;padding:26px;background:var(--surface);box-shadow:0 18px 50px rgba(11,12,9,.08);}");
            ...
            html.AppendLine(".meta{text-align:center;font-size:12px;color:var(--muted);margin:0;}");
            html.AppendLine(".divider{border-top:1px solid var(--line);margin:16px 0 18px;}");
            ...
            html.AppendLine(".note-panel{border:1px solid var(--line);border-radius:14px;padding:12px 14px;font-size:12px;font-style:italic;min-height:44px;background:var(--paper);}");
            html.AppendLine(".summary-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-bottom:8px;}");
            html.AppendLine(".metric-card{border:1px solid var(--line);border-radius:14px;background:var(--paper);padding:10px 12px 12px;}");
            ...
            html.AppendLine(".counts{text-align:center;font-size:11px;color:var(--muted);margin:6px 0 0;}");
            ...
            html.AppendLine("th,td{border:1px solid var(--line);padding:6px 7px;vertical-align:middle;}");
            html.AppendLine("thead th{background:#ece9df;font-weight:700;}");
            html.AppendLine(".amount{background:#faf9f4;text-align:right;}");
            html.AppendLine(".center{text-align:center;}");
            html.AppendLine(".right{text-align:right;}");
            html.AppendLine(".total-row td{background:rgba(185,255,0,.28);font-weight:700;}");
            ...
            html.AppendLine(".footer{text-align:right;font-size:11px;color:var(--muted);margin-top:10px;}");
            html.AppendLine("@media(max-width:720px){body{padding:10px}.page{border-radius:14px;padding:14px}.summary-grid,.exec-grid{grid-template-columns:1fr}.table-panel{overflow-x:auto}.hero-title{font-size:19px}table{min-width:620px}}");
            html.AppendLine("@media print{@page{size:A4;margin:12mm}body{background:#fff;padding:0}.page{max-width:none;border:0;border-radius:0;padding:0;box-shadow:none}.note-panel,.metric-card,thead th,.total-row td{-webkit-print-color-adjust:exact;print-color-adjust:exact}}");
