...
const copy = {
  tr: {
    ...
    "nav.home": "Ana sayfa", "nav.finance": "Finans durumu", "nav.incomeExpense": "Gelir / gider", "nav.quickSale": "Hızlı satış", "nav.stock": "Ürün ve stok", "nav.marketplace": "Tedarikçi pazaryeri", "nav.accounts": "Cari hesaplar", "nav.invoices": "Faturalar", "nav.payments": "Tahsilat ve ödeme", "nav.bank": "Banka eşleştirme", "nav.reports": "Raporlar", "nav.chat": "Sohbetler", "nav.accountant": "Muhasebeci paneli", "nav.clients": "Müşterilerim", "nav.accountants": "Muhasebeciler", "nav.admin": "Yönetim", "nav.settings": "Ayarlar", "nav.business": "İşletme", "nav.plan": "Plan ve faturalama", "nav.gib": "GİB portal", "nav.telegram": "Telegram", "scope.notice": "Uygulama ekranlarının bir bölümü henüz Türkçe sunulur.",
  ...
  en: {
    ...
    "nav.home": "Home", "nav.finance": "Financial overview", "nav.incomeExpense": "Income & expenses", "nav.quickSale": "Quick sale", "nav.stock": "Products & inventory", "nav.marketplace": "Supplier marketplace", "nav.accounts": "Accounts", "nav.invoices": "Invoices", "nav.payments": "Collections & payments", "nav.bank": "Bank reconciliation", "nav.reports": "Reports", "nav.chat": "Chats", "nav.accountant": "Accountant workspace", "nav.clients": "My clients", "nav.accountants": "Accountants", "nav.admin": "Administration", "nav.settings": "Settings", "nav.business": "Business", "nav.plan": "Plan & billing", "nav.gib": "GİB portal", "nav.telegram": "Telegram", "scope.notice": "Some application screens are currently available in Turkish.",
  ...
  de: {
    ...
    "nav.home": "Startseite", "nav.finance": "Finanzübersicht", "nav.incomeExpense": "Einnahmen & Ausgaben", "nav.quickSale": "Schnellverkauf", "nav.stock": "Produkte & Bestand", "nav.marketplace": "Lieferantenmarktplatz", "nav.accounts": "Konten", "nav.invoices": "Rechnungen", "nav.payments": "Einzüge & Zahlungen", "nav.bank": "Bankabgleich", "nav.reports": "Berichte", "nav.chat": "Chats", "nav.accountant": "Steuerberaterbereich", "nav.clients": "Meine Kunden", "nav.accountants": "Steuerberater", "nav.admin": "Verwaltung", "nav.settings": "Einstellungen", "nav.business": "Unternehmen", "nav.plan": "Plan & Abrechnung", "nav.gib": "GİB-Portal", "nav.telegram": "Telegram", "scope.notice": "Einige Anwendungsseiten sind derzeit auf Türkisch verfügbar.",
