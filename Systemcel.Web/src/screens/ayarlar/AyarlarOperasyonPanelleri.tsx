...
interface HariciOnizleme { draftId: string; type: HariciVeriTuru; fileName: string; totalRows: number; validRows: number; duplicateRows: number; headers: string[]; sampleRows: Record<string, string>[]; suggestedMappings?: { kaynakSutun: string; hedefAlan: string; guven: number }[]; errors: { row: number; message: string }[]; unsupportedReason?: string; }
